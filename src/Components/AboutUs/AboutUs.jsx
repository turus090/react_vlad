      ...
      <section className={s.aboutSection}>
        <div className={s.aboutSection_wrapper}>
          <div className={s.left}>
            ...
            <p className={s.aboutSection_wrapper_text}>
              Працюю як індивідуально, так і розробляю програми тренувань та
              плани харчування для всіх. Успішно працюю з людьми різного віку та
              рівня підготовки. Підготовка до змагань з бодибілдингу, просто
              схуднути, набрати м'язову масу.
            </p>
          </div>
