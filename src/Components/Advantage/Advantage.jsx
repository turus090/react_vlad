          ...
          <ul className={s.advantage_cards}>
            <li className={s.advantage_cards_item}>
              ...
              <p className={s.advantage_cards_item_text}>
                Контрольний тижневий звіт та аналіз проробленоїроботи за
                тиждень. У звіт входять фото заміри, вага. Звіт робимо раз у
                тиждень та в один і той самий день.
              </p>
            </li>
            <li className={s.advantage_cards_item}>
              <div className={s.advantage_cards_item_up}>
            ...
            <li className={s.advantage_cards_item}>
              ...
              <p className={s.advantage_cards_item_text}>
                ...
                алергії та непереносність продуктів. Мені потрібна ваша
                продуктова корзина.
              </p>
            </li>
            <li className={s.advantage_cards_item}>
              ...
              <p className={s.advantage_cards_item_text}>
                ...
                цікавлять (харчування, тренування, здоров'я, мотивація). Наша
                мета – єдина.
              </p>
            </li>
            <li className={s.advantage_cards_item}>
              ...
              <p className={s.advantage_cards_item_text}>
                Ви робите відео останнього підходу кожної вправи і надсилайте
                мені на перевірку. Від мене відео виконання вправ, якщо не
                знаєте як її виконувати.
              </p>
            </li>
            <li className={s.advantage_cards_item}>
              <div className={s.advantage_cards_item_up}>
              ...
              <p className={s.advantage_cards_item_text}>
                Підбір бадів для здоров’я. Провірка мед. аналізів. Стероїдні
                курси для спортсменів. Контроль аналізів на курсі. За вашим
                побажанням.
              </p>
            </li>
          </ul>
